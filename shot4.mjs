...
await page.evaluate(() => window.__setCamera({ distance: 1.6, height: 1.5, targetY: 1.45, fov: 30 }));
await page.waitForFunction(() => window.__glbDebug.frame > 0, null, { timeout: 10000 });
