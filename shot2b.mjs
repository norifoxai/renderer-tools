...
await page.waitForFunction(() => window.__glbDebug && (window.__glbDebug.error || window.__glbDebug.modelLoaded || window.__glbDebug.hairFlexDeg), null, { timeout: 120000 }).catch(()=>{});
